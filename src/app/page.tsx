...
export default function LandingPage() {
  return (
    <div className="bg-[#0a0a0a] text-zinc-100 min-h-screen font-sans selection:bg-orange-500 selection:text-white">
      ...
      <section className="pt-48 pb-20 px-6 border-b border-zinc-900">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-4">
            ...
            {/* Meet the Team -> Sellf Media External Link */}
            <Link 
      ...
      <section className="py-24 px-6 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4 auto-rows-[300px]">
          ...
          <div className="md:col-span-8 bg-[#111] border border-zinc-800 rounded-[2.5rem] p-10 flex flex-col justify-between overflow-hidden relative group">
            ...
            <div className="absolute -right-10 -bottom-10 w-64 h-64 bg-orange-500/5 rounded-full blur-3xl group-hover:bg-orange-500/10 transition-all"></div>
          </div>
          ...
          <div className="md:col-span-8 bg-zinc-100 text-black border border-zinc-800 rounded-[2.5rem] p-10 flex items-center justify-between">
            <div className="max-w-md">
              <h3 className="text-3xl font-bold tracking-tight mb-4 text-black">Ready to outsmart the competition?</h3>
